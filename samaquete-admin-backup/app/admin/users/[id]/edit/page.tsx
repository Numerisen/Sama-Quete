    ...
    <div className="max-w-xl mx-auto">
      <Card className="shadow-xl bg-white/80 border-0 rounded-2xl mt-8">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-black mb-1">Modifier l'utilisateur admin</CardTitle>
          <p className="text-black/80 text-sm">Modifiez les informations de l'administrateur.</p>
        </CardHeader>
        <CardContent>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <label className="block text-black font-medium">Mot de passe (laisser vide pour ne pas changer)</label>
              <div className="flex items-center gap-2">
                <Key className="w-5 h-5 text-black" />
                <Input name="password" type="password" value={form.password} onChange={handleChange} placeholder="Nouveau mot de passe" className="bg-white/90 border-blue-200" />
              </div>
            </div>
            <div className="space-y-2">
