...
export default function CreateDonationEventPage() {
  ...
  const [formData, setFormData] = useState({
    title: "",
    description: "",
    type: "prière" as DonationEvent['type'],
    parishId: "",
    targetAmount: "",
    startDate: "",
    endDate: "",
  ...
  const eventTypes = [
    { value: "prière", label: "prière d'intention", icon: "⛪" },
      ...
      <Card className="shadow-xl bg-white/80 border-0 rounded-2xl">
        <CardHeader>
          ...
          <p className="text-black/80">
            Créez un événement pour collecter des dons (prière, quête, événement spécial...)
          </p>
        </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Ex: prière d'intention pour..."
