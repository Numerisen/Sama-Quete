...
/**
 * Page "Dons" - Admin Église (LECTURE SEULE)
 * 
 * ⛔ Cette page est en lecture seule - Aucune modification des dons n'est autorisée
 * Les dons sont toujours rattachés à la paroisse, jamais à l'église
 */
...
export default function ÉgliseDonationsPage() {
  ...
  // Fonctions désactivées en mode lecture seule
  const handleDeleteDonation = (id: string) => {
    toast({
      title: "Action non autorisée",
      description: "Cette page est en lecture seule. Les dons ne peuvent pas être modifiés.",
      variant: "destructive"
    })
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Dons de la eglise</h1>
            <p className="text-gray-600 mt-1">
              {eglise} • Consultation des dons (lecture seule)
            </p>
          </div>
              ...
              {filteredDonations.map((donation) => (
                <div key={donation.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    {/* Mode lecture seule - aucun bouton d'action */}
                    <Button variant="outline" size="sm" disabled title="Mode lecture seule">
            ...
            {filteredDonations.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-500">
                  ⛔ Cette page est en lecture seule. Les dons sont gérés par l'admin paroisse.
                </p>
              </div>
            )}
          </CardContent>
