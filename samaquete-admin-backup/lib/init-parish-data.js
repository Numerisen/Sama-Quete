...
const prayerTimes = [
  {
    ...
    active: true,
    description: "prière quotidienne du matin",
    parishId: PARISH_ID
  },
  {
    name: "prière du dimanche",
    time: "10:00",
    days: ["Dimanche"],
    active: true,
    description: "prière dominicale principale",
    parishId: PARISH_ID
  },
  {
    name: "Vêpres",
  ...
  },
  {
    ...
    days: ["Samedi"],
    active: false,
    description: "prière anticipée du dimanche",
    parishId: PARISH_ID
  }
];
...
const activities = [
  {
    ...
    description: "prière principale du dimanche avec la communauté",
    date: "2024-01-21",
    time: "10:00",
...
const news = [
  {
    title: "prière de dimanche",
    content: "Nous vous invitons à participer à la prière dominicale qui aura lieu ce dimanche à 10h00. Cette célébration sera animée par la chorale paroissiale.",
    excerpt: "Invitation à la prière dominicale avec la chorale paroissiale",
    category: "Liturgie",
    published: true,
    parishId: PARISH_ID
  },
