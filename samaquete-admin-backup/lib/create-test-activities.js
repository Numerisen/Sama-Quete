...
async function createTestActivities() {
  ...
  const activities = [
    ...
    },
    {
      ...
      entityType: 'news',
      entityId: 'news-1',
      entityName: 'prière de Noël 2024',
      timestamp: new Date(Date.now() - 60 * 60 * 1000), // Il y a 1h
      changes: {
        before: null,
        after: {
          title: 'prière de Noël 2024',
          content: 'Nous vous invitons à la prière de Noël...',
          category: 'Événement',
          published: true
        },
    ...
    },
    {
      ...
      entityName: 'Offrande de prière',
      timestamp: new Date(Date.now() - 30 * 60 * 1000), // Il y a 30min
      changes: {
        before: null,
        after: {
          name: 'Offrande de prière',
          description: 'Pour les intentions de prière',
    ...
    },
    {
      ...
      changes: {
        ...
        after: {
          title: 'prière de Noël 2024 - Mise à jour',
          content: 'Nous vous invitons à la prière de Noël... L\'horaire a été modifié.',
          category: 'Événement',
          published: true
        },
