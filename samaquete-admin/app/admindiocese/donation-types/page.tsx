...
export default function AdminDioceseDonationTypesPage() {
  ...
  const loadDonationTypes = async () => {
    try {
      setLoading(true)
      const types = await DonationTypeService.getByDiocese(diocese)
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Gérez les types de dons disponibles pour {diocese}
              </p>
            </div>
            <Button
