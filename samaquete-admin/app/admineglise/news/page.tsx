    ...
    <div className="space-y-8">
      <Card className="bg-white shadow-lg rounded-xl">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            <CardTitle className="text-2xl font-bold text-gray-800">Actualités de la eglise</CardTitle>
              ...
              <div className="mb-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
                ...
                <div className="mb-3">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Si vide, "Église" sera affiché par défaut
                  </p>
                </div>
                ...
                {/*{newNews.showAuthor ? (
                  <p className="text-xs text-green-600 mt-2 flex items-center gap-1 bg-green-50 p-2 rounded">
                    <span>✓</span> L'auteur sera visible dans l'app : <strong>"{newNews.author || 'Église'}"</strong>
                  </p>
                ) : (
