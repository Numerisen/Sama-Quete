// Script automatisé pour créer les profils Firestore
...
async function createAllProfiles() {
  console.log('🚀 Création automatique des profils Firestore...')
  console.log('📋 Configuration Firebase :', firebaseConfig.projectId)
